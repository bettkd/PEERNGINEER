...
*/
exports.createStoreManagementClient = function (credentials, baseUri, filters) {
  return new exports.StoreManagementClient.StoreManagementClient(credentials, baseUri, filters);
};
