...
var JobOperations = ( /** @lends JobOperations */ function() {
  ...
  JobOperations.prototype.getJob = function(jobId, callback) {
    ...
    url2 = url2 + ':443/templeton/v1/jobs/';
      ...
      if (statusCode === 200) {
        ...
        if (responseDoc !== null && responseDoc !== undefined) {
          ...
          if (statusValue !== null && statusValue !== undefined) {
            ...
            var jobPriorityValue = statusValue['jobPriority'];
            if (jobPriorityValue !== null && jobPriorityValue !== undefined) {
              var jobPriorityInstance = jobPriorityValue;
              statusInstance.jobPriority = jobPriorityInstance;
            }
          ...
          if (profileValue !== null && profileValue !== undefined) {
            ...
            var userValue = profileValue['user'];
            if (userValue !== null && userValue !== undefined) {
              var userInstance = userValue;
              profileInstance.user = userInstance;
            }
          ...
          var userValue2 = responseDoc['user'];
          if (userValue2 !== null && userValue2 !== undefined) {
            var userInstance2 = userValue2;
            jobDetailInstance.user = userInstance2;
          }
          ...
          if (userargsValue !== null && userargsValue !== undefined) {
            var userargsInstance = { arg: [], define: [], libjars: [] };
            ...
            var usernameValue2 = userargsValue['user.name'];
            if (usernameValue2 !== null && usernameValue2 !== undefined) {
              var usernameInstance2 = usernameValue2;
              userargsInstance.username = usernameInstance2;
            }
            ...
            var classValue = userargsValue['class'];
            if (classValue !== null && classValue !== undefined) {
              var classInstance = classValue;
              userargsInstance.jarclass = classInstance;
            }
            
            var libjarsArray = userargsValue['libjars'];
            if (libjarsArray !== null && libjarsArray !== undefined) {
              for (var loweredIndex3 = 0; loweredIndex3 < libjarsArray.length; loweredIndex3 = loweredIndex3 + 1) {
                var libjarsValue = libjarsArray[loweredIndex3];
                userargsInstance.libjars.push(libjarsValue);
              }
            }
          }
          ...
          if (jobListArray !== null && jobListArray !== undefined) {
            for (var loweredIndex1 = 0; loweredIndex1 < jobListArray.length; loweredIndex1 = loweredIndex1 + 1) {
              ...
              if (detailValue !== null && detailValue !== undefined) {
                var detailInstance = detailValue;
                jobListJsonObjectInstance.detail = detailInstance;
              }
              
              var idValue = jobListValue['id'];
              if (idValue !== null && idValue !== undefined) {
                var idInstance = idValue;
  ...
  JobOperations.prototype.submitHiveJob = function(parameters, callback) {
    ...
    url2 = url2 + 'https://';
    url2 = url2 + encodeURIComponent(this.client.clusterDnsName);
    url2 = url2 + ':443/templeton/v1/hive';
    var queryParameters = [];
    if (this.client.credentials.username !== null && this.client.credentials.username !== undefined) {
      queryParameters.push('user.name=' + encodeURIComponent(this.client.credentials.username));
    }
    ...
    // Serialize Request
    var requestContent = 'user.name=' + parameters.userName + '&execute=' + parameters.query + '&file=' + parameters.file + '&define=' + parameters.defines + '&arg=' + parameters.arguments + '&files=' + parameters.files + '&statusdir=' + parameters.statusDir + '&enablelog=' + parameters.enableLog;
  ...
  JobOperations.prototype.submitMapReduceJob = function(parameters, callback) {
    ...
    url2 = url2 + 'https://';
    url2 = url2 + encodeURIComponent(this.client.clusterDnsName);
    url2 = url2 + ':443/templeton/v1/mapreduce/jar';
    var queryParameters = [];
    if (this.client.credentials.username !== null && this.client.credentials.username !== undefined) {
      queryParameters.push('user.name=' + encodeURIComponent(this.client.credentials.username));
    }
  ...
  JobOperations.prototype.submitMapReduceStreamingJob = function(parameters, callback) {
    ...
    url2 = url2 + 'https://';
    url2 = url2 + encodeURIComponent(this.client.clusterDnsName);
    url2 = url2 + ':443/templeton/v1/mapreduce/streaming';
    var queryParameters = [];
    if (this.client.credentials.username !== null && this.client.credentials.username !== undefined) {
      queryParameters.push('user.name=' + encodeURIComponent(this.client.credentials.username));
    }
  ...
  JobOperations.prototype.submitPigJob = function(parameters, callback) {
    ...
    url2 = url2 + 'https://';
    url2 = url2 + encodeURIComponent(this.client.clusterDnsName);
    url2 = url2 + ':443/templeton/v1/pig';
    var queryParameters = [];
    if (this.client.credentials.username !== null && this.client.credentials.username !== undefined) {
      queryParameters.push('user.name=' + encodeURIComponent(this.client.credentials.username));
    }
